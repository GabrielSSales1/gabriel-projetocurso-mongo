package com.GabrielSales.workshopmongo.config;

import com.GabrielSales.workshopmongo.domain.Post;
import com.GabrielSales.workshopmongo.domain.User;
import com.GabrielSales.workshopmongo.dto.AuthorDTO;
import com.GabrielSales.workshopmongo.dto.CommentDTO;
...
public class Instantiantion implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bomd dia", "Acordei feliz hoje!", new AuthorDTO(maria));
